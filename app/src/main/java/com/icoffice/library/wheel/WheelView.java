...
package com.icoffice.library.wheel;
...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.library_wheel_val);
		}
		...
		setBackgroundResource(R.drawable.library_wheel_bg);
	}
