	...
	public void run() {
		if (downLength < block) {// 未下载完成
			try {
				...
				int offset = 0;
				CommonUtils.showLog(CommonUtils.UPGRADE_TAG, "Thread " + this.threadId
				...
				threadfile.close();
				inStream.close();
				CommonUtils.showLog(CommonUtils.UPGRADE_TAG, "Thread " + this.threadId + " download finish");
				this.finish = true;
			} catch (Exception e) {
				this.downLength = -1;
				CommonUtils.showLog(CommonUtils.UPGRADE_TAG, "Thread " + this.threadId + ":" + e);
			}
		}
	}
